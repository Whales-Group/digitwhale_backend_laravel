...
class BaseHandler
{
    public function handle(Request $request): ?JsonResponse
    {
        ...
        return match ($eventEnum) {
            FincraWebhookEvent::TRANSFER_SUCCESS => \App\Gateways\Fincra\Handlers\HandleTransferSuccess::handle($transactionData),
            FincraWebhookEvent::TRANSFER_FAILED => \App\Gateways\Fincra\Handlers\HandleTransferFailed::handle($transactionData),
